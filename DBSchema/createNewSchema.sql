...
-- -----------------------------------------------------
CREATE TABLE `calculator`.`complexities` (
...
-- -----------------------------------------------------
CREATE TABLE `calculator`.`expressions` (
...
-- -----------------------------------------------------
CREATE TABLE `calculator`.`expression_list` (`expression_id` INT, `expression` INT, `answer` INT, `date` INT, `type` INT, `complexity_name` INT, `description` INT);
